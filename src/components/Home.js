...
import HomeWeb from '../assets/img/home_web.svg';
...
class Home extends Component {
  ...
  hoverPrestashop(){
      this.setState({
        prestashop: !this.state.prestashop
      })
  }
  ...
  hoverDrupal(){
      this.setState({
        drupal: !this.state.drupal
      })
  }

  hoverSymfony(){
      this.setState({
        symfony: !this.state.symfony
      })
  }
      ...
      <div>
        <div className="row home">
           <div className="col s12 m5 offset-m1">
            ...
            <p className="description">Chaque projet web est unique, et mérite le meilleur. Chez Speedmonkey, nous vous proposons une solution technique sur-mesure adapté à votre besoin.</p>
           ...
           <div className="col s12 m5 center">
            <img src={HomeWeb} alt="WebSite" className="website"/>
           </div>
        </div>
        <div className="row">
